...
<div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <a href="{{ route('page.coordinatorCreate') }}" class="btn btn-primary" >Add New Co-ordinator </a>
...
{{--            <th scope="col">Photo</th>--}}
        ...
        @forelse($coordinators as $key => $user)
            <tr>
                <td> {{$key+1}}</td>
...
{{--                <a href=" {{route('children.edit', $user->id)}} ">--}}
                <a href=" {{url('/edit_user/Coordinator/1',$user->id)}} ">
                ...
                <a href="{{url('/users/coordinator/view/teachers/'.$user->id)}}" class="btn btn-sm btn-info">View Teachers</a>
            </td>
        </tr>
        @empty
