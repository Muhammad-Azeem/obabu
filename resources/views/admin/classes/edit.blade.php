...
@section('content')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        @endif
        <!--begin::Form-->
            <form class="kt-form kt-form--label-right" action="{{ route('page.classes-update')}}" method="post" id="kt_form_1">
                @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class='input-group'>
                                ...
                                <input type='text' class="form-control @error('name') border-danger @enderror" name="name" value="{{$class->name}}"/>
                            </div>
                            @error('name')
...
{{--                                <option selected value="">Select teacher</option>--}}
                                @foreach($teachers as $user)
                                    <option @if($class->teacher_id == $user->id) selected @endif value="{{$user->id}}">{{$user->name}}</option>
                                @endforeach
                    ...
                    <div class="form-group row " id="clone">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12 ">
                            <div class="input-group timepicker ">
                                ...
                                <input class="form-control date_picker " required readonly="" value="{{date('m/d/Y', strtotime($day->date_time))}}" name="date_time[]" placeholder="Select Date" type="text">
                                <input class="form-control" required value="{{date('H:i', strtotime($day->date_time))}}" name="time[]" placeholder="Select time" type="time">
                ...
                <a class="add_field_button btn btn-warning">Add another class</a>
            </form>
        </div>
    </div>
