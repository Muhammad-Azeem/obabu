                                ...
                                <div class="kt-iconbox__body">
                                    ...
                                    <div class="kt-iconbox__desc">
                                        <h3 class="kt-iconbox__title">
                                            <a class="kt-link" href="#">Total Teachers</a>
                                        </h3>
                        ...
                        <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slow">
                            <div class="kt-portlet__body">
                                <div class="kt-iconbox__body">
                                    ...
                                    <div class="kt-iconbox__desc">
                                        <h3 class="kt-iconbox__title">
                                            <a class="kt-link" href="#">Total Childrens</a>
                                        </h3>
                                        <div class="kt-iconbox__content">
                                            <b>{{ $childrencount }}</b>
                                        </div>
                        ...
                        <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slow">
                            <div class="kt-portlet__body">
                                <div class="kt-iconbox__body">
                                    ...
                                    <div class="kt-iconbox__desc">
                                        <h3 class="kt-iconbox__title">
                                            <a class="kt-link" href="#">Total Parents</a>
                                        </h3>
                                        <div class="kt-iconbox__content">
                                            <b>{{ $parentcount }}</b>
                                        </div>
                        ...
                        <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slow">
                            <div class="kt-portlet__body">
                                <div class="kt-iconbox__body">
                                    ...
                                    <div class="kt-iconbox__desc">
                                        <h3 class="kt-iconbox__title">
                                            <a class="kt-link" href="#">Total Subscribers</a>
                                        </h3>
                                        <div class="kt-iconbox__content">
                                            <b>{{$subscribercount}}</b>
                                        </div>
                        ...
                        <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slow">
                            <div class="kt-portlet__body">
                                <div class="kt-iconbox__body">
                                    ...
                                    <div class="kt-iconbox__desc">
                                        <h3 class="kt-iconbox__title">
                                            <a class="kt-link" href="#">Total Packages</a>
                                        </h3>
                                        <div class="kt-iconbox__content">
                                            <b>{{ $packagecount }}</b>
                                        </div>
