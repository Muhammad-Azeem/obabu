                ...
                <div class="col-md-6">
                    <div class="banner-details">
                        ...
                        <div class="join-website text-right mt-4">
                            <a href="{{route('membership')}}"><button class="btn btn-primary">Join Website</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="{{asset('public/assets/images/sales-1.png')}}" class="img-fluid banner-image" alt="Laptop Image" title="Instant Video Chat">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="membership-left-details">
                        ...
                        <div class="mt-4">
                            <a href="{{route('register')}}"> <button class="btn btn-primary mr-3 shadow">SIGN UP</button></a>
                            <button class="btn btn-secondary ml-0 ml-md-3 mt-2 mt-md-0 shadow">CONTACT US</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="{{asset('public/assets/images/sales-membership.png')}}" class="img-fluid right-image" alt="Membership" title="Membership">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="left-images">
                        <img src="{{asset('public/assets/images/sales-membership-3.png')}}" class="img-fluid pl-3" width="400" height="350" alt="Membership left">
                        <img src="{{asset('public/assets/images/sales-membership-2.png')}}" class="img-fluid left-bottom-image" alt="Membership left" title="Membership">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-12 text-right">
                    <img src="{{asset('public/assets/images/sales-membership-4.png')}}" class="img-fluid membership-bottom
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="{{asset('public/assets/images/our-services-1.png')}}" alt="Service 1">
                                <div class="card-body">
                        ...
                        <div class="col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="{{asset('public/assets/images/our-services-2.png')}}" alt="Service 2">
                                <div class="card-body">
                                    <p class="card-text p-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                                        eirmod tempor invidunt ut labore et dolore</p>
                                    <a href="#" class="btn btn-custom font-weight-bold mt-2 mb-2">READ MORE</a>
                        ...
                        <div class="col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="{{asset('public/assets/images/our-services-3.png')}}" alt="Service 3">
                                <div class="card-body">
                                    <p class="card-text p-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                                        eirmod tempor invidunt ut labore et dolore</p>
                                    <a href="#" class="btn btn-custom font-weight-bold mt-2 mb-2">READ MORE</a>
