        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <img alt="Pic" class="kt-radius-100" src="@if(auth()->user()->profile_pic == null) {{asset('assets/media/users/300_25.jpg')}} @else {{asset('assets/media/users/'.auth()->user()->profile_pic)}} @endif" />
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <!--begin: Head -->
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url('assets/media/misc/bg-1.jpg'); background: #0c5ce1">
                    <div class="kt-user-card__avatar">
                        <img class="kt-hidden" alt="Pic" src="@if(auth()->user()->profile_pic == null) {{asset('assets/media/users/300_25.jpg')}} @else {{asset('assets/media/users/'.auth()->user()->profile_pic)}} @endif" />
                        <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
...
{{--                    </div>--}}
                ...
                <div class="kt-notification">
                    <a href="{{url('/edit_user/admin/0/'.auth()->user()->id)}}" class="kt-notification__item">
                        <div class="kt-notification__item-icon">
