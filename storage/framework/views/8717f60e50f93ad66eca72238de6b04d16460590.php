<footer class="footer p-3">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <a href="<?php echo e(url('/')); ?>"> <img src="<?php echo e(asset('public/assets/images/footer-logo.png')); ?>" class="img-fluid" alt="footer logo"></a>
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <img src="<?php echo e(asset('public/assets/images/footer.png')); ?>" class="img-fluid footer-image" alt="footer image"  width="250" height="250">
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/obabu/resources/views/layouts/footer.blade.php ENDPATH**/ ?>