            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    ...
                    <div class="mt-4 pt-2 text-center">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary mr-3 shadow">SIGN UP</a>
                        <a class="btn btn-secondary ml-3 shadow">CONTACT US</a>
                    </div>
                    <img src="<?php echo e(asset('public/assets/images/home-top.png')); ?>" class="img-fluid"  width="450" height="400">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="<?php echo e(asset('public/assets/images/why-us-1.png')); ?>" alt="Why Us 1">
                                <div class="card-body">
                        ...
                        <div class="col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="<?php echo e(asset('public/assets/images/why-us-2.png')); ?>" alt="Why Us 2">
                                <div class="card-body">
                                    <p class="card-text p-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore</p>
                                    <a href="#" class="btn btn-custom font-weight-bold mt-2 mb-2">READ MORE</a>
                                    <div class="card-footer mt-1"></div>
                        ...
                        <div class="col-md-4 text-center">
                            <div class="card shadow-lg">
                                <img class="card-img-top img-fluid" src="<?php echo e(asset('public/assets/images/why-us-3.png')); ?>" alt="Why Us 3">
                                <div class="card-body">
                                    <p class="card-text p-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore</p>
                                    <a href="#" class="btn btn-custom font-weight-bold mt-2 mb-2">READ MORE</a>
                                    <div class="card-footer mt-1"></div>
    ...
    <section class="our-team">
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col">
                    <img src="<?php echo e(asset('public/assets/images/our-team-1.png')); ?>" class="img-fluid" alt="image" width="200" height="150" />
                </div>
            </div>
            <div class="row">
            ...
            <section class="explore-the-fun">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center mt-5 pb-5">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('public/assets/images/explore-fun-bg.png')); ?>" class="img-fluid" alt="explore image"/>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/obabu/resources/views/home/index.blade.php ENDPATH**/ ?>